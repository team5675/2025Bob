...
public final class ElevatorConstants {
	...
	public static final double L3_HEIGHT = 1;
	public static final double L2_HEIGHT = 1;
    ...
    public static final LinearVelocity ZEROING_VELOCITY = MetersPerSecond.of(0.30);
}
